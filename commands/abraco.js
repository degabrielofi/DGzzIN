      ...
      .addFields(
        {
          ...
          value:
            "Utilize este comando para abraçar um usuário do servidor. Escreva com `d$abraco (usuário).`",
          inline: true,
        },
        {
          name: "<:Sinonimos:1214053417933340692> Sinônimos:",
          value: "`d$abraco` `d$abracar` `d$hug` ",
          inline: true,
        },
        {
          name: "\u200b",
        ...
        },
        {
          ...
          value: "`d$abraco @YGɑbrielGØDs`\n`d$abraco 812911319695097856`",
          inline: true,
        }
      );
