      ...
      .addFields(
        {
          ...
          value:
            "Utilize este comando para abraçar um usuário do servidor. Escreva com `d$abracar (usuário).`",
          inline: true,
        },
        {
          name: "<:Sinonimos:1214053417933340692> Sinônimos:",
          value: "`d$abracar` `d$abraco` `d$hug` ",
          inline: true,
        },
        {
          name: "\u200b",
        ...
        },
        {
          ...
          value: "`d$abracar @YGɑbrielGØDs`\n`d$abracar 812911319695097856`",
          inline: true,
        }
      );
