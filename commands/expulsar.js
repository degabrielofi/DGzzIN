      ...
      .addFields(
        {
          ...
          value:
            "Utilize este comando para expulsar um usuário do seu servidor. Escreva com `d$expulsar (usuário) (motívo).`",
          inline: true,
        },
        {
          name: "<:Sinonimos:1214053417933340692> Sinônimos:",
          value: "`d$expulsar` `d$kick`",
          inline: true,
        },
        {
          name: "\u200b",
        ...
        },
        {
          ...
          value:
            "`d$expulsar @YGɑbrielGØDs Divulgação`\n`d$expulsar 812911319695097856 spam no chat`",
          inline: true,
        }
      );
