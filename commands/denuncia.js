      ...
      .addFields(
        {
          ...
          value:
            "Utilize este comando para denúnciar alguém do servidor. Escreva com `d$denuncia (Denúncia).`",
          inline: true,
        },
        {
          name: "<:Sinonimos:1214053417933340692> Sinônimos:",
          value: "`d$denuncia` `d$denunciar`",
          inline: true,
        },
        {
          name: "\u200b",
        ...
        },
        {
          ...
          value: "`d$denuncia O YGɑbrielGØDs#3317 me ofendeu.`",
          inline: true,
        }
      );
    if (!args[0])
