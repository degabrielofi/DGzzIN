  ...
  run: async (client, message, args) => {
    ...
    try {
      ...
      let degabrielofi = new MessageEmbed()
        .setAuthor("COMANDO: LIMPAR", "https://i.imgur.com/0b6Ohrl.png")
        ...
        .addFields(
          {
            ...
            value:
              "Utilize este comando para limpar mensagens no chat. Escreva com `d$limpar (número de 1 a 99).`",
            inline: true,
          },
          {
            name: "<:Sinonimos:1214053417933340692> Sinônimos:",
            value: "`d$limpar` `d$clear`",
            inline: true,
          },
          {
            name: "\u200b",
