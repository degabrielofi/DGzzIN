      ...
      .addFields(
        {
          ...
          value:
            "Utilize este comando para remover um cargo em um usuário do servidor. Escreva com `d$removecargo (usuário) (cargo).`",
          inline: true,
        },
        {
          name: "<:Sinonimos:1214053417933340692> Sinônimos:",
          value: "`d$removecargo` `d$removercargo` `d$remcargo` ",
          inline: true,
        },
        {
          name: "\u200b",
        ...
        },
        {
          ...
          value:
            "`d$removecargo @YGɑbrielGØDs @❰⭐❱❱❱ Parceiro ✫✫✫ `\n`d$removecargo 812911319695097856 @❰⭐❱❱❱ Parceiro ✫✫✫ `",
          inline: true,
        }
      );
