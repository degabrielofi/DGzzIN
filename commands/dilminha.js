    ...
    .addFields(
      {
        ...
        value:
          "Utilize este comando para que a Dilma fale algo. Escreva com `d$dilminha (Mensagem).`",
        inline: true,
      },
      {
        name: "<:Sinonimos:1214053417933340692> Sinônimos:",
        value: "`d$dilminha` `d$dilma`",
        inline: true,
      },
      {
        name: "\u200b",
      ...
      },
      {
        ...
        value: "`d$dilminha Vai todo mundo perder.`",
        inline: true,
      }
    );

  let img = jimp.read("https://i.imgur.com/ZiPRCJX.jpeg");
  if (!args[0])
  ...
  img.then((image) => {
    jimp.loadFont(jimp.FONT_SANS_32_BLACK).then((font) => {
      ...
      image.getBuffer(jimp.MIME_PNG, (err, i) => {
        message.reply({
          content: `${message.author}`,
          files: [{ attachment: i, name: "dilma.jpeg" }],
        });
      });
    });
  });
