      ...
      .addFields(
        {
          ...
          value:
            "Utilize este comando para reportar um bug sobre alguma coisa no servidor. Escreva com `d$repbug (Bug).`",
          inline: true,
        },
        {
          name: "<:Sinonimos:1214053417933340692> Sinônimos:",
          value: "`repbug` `d$reportarbug` `d$reportbug`",
          inline: true,
        },
        {
          name: "\u200b",
        ...
        },
        {
          ...
          value: "`d$repbug Tal comando está bugado.`",
          inline: true,
        }
      );
    if (!args[0])
