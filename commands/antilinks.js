      ...
      .addFields(
        {
          ...
          value:
            "Utilize este comando para proibir links em seu servidor. Escreva com `d$antilinks on` para ativar ou `d$antilinks off` para desativar.",
          inline: true,
        },
        {
          name: "<:Sinonimos:1214053417933340692> Sinônimos:",
          value: "`d$antilinks` `d$antilink`",
          inline: true,
        },
        {
          name: "\u200b",
