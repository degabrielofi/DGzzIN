      ...
      .addFields(
        {
          ...
          value:
            "Utilize este comando para banir um usuário do seu servidor. Escreva com `d$ban (usuário) (motívo).`",
          inline: true,
        },
        {
        ...
        },
        {
          ...
          value:
            "`d$ban @YGɑbrielGØDs Divulgação`\n`d$ban 812911319695097856 spam no chat`",
          inline: true,
        }
      );
