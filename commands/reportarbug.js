      ...
      .addFields(
        {
          ...
          value:
            "Utilize este comando para reportar um bug sobre alguma coisa no servidor. Escreva com `d$reportarbug (Bug).`",
          inline: true,
        },
        {
          name: "<:Sinonimos:1214053417933340692> Sinônimos:",
          value: "`d$reportarbug` `d$reportbug` `repbug`",
          inline: true,
        },
        {
          name: "\u200b",
        ...
        },
        {
          ...
          value: "`d$reportarbug Tal comando está bugado.`",
          inline: true,
        }
      );
    if (!args[0])
