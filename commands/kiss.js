      ...
      .addFields(
        {
          ...
          value:
            "Utilize este comando para beijar um usuário do servidor. Escreva com `d$kiss (usuário).`",
          inline: true,
        },
        {
          name: "<:Sinonimos:1214053417933340692> Sinônimos:",
          value: "`d$kiss` `d$beijar` `d$beijo`",
          inline: true,
        },
        {
          name: "\u200b",
        ...
        },
        {
          ...
          value: "`d$kiss @YGɑbrielGØDs`\n`d$kiss 812911319695097856`",
          inline: true,
        }
      );
