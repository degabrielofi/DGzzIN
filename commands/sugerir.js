      ...
      .addFields(
        {
          ...
          value:
            "Utilize este comando para sugerir algo para o servidor. Escreva com `d$sugerir (Sugestão).`",
          inline: true,
        },
        {
          name: "<:Sinonimos:1214053417933340692> Sinônimos:",
          value: "`d$sugerir` `d$sugestao`",
          inline: true,
        },
        {
          name: "\u200b",
        ...
        },
        {
          ...
          value:
            "`d$sugerir Sugiro que adicione um bot de musica no servidor.`",
          inline: true,
        }
      );
    if (!args[0])
