  ...
  run: async (client, message, args) => {
        ...
        .addFields(
          {
            ...
            value:
              "Utilize este comando para adicionar um emoji em seu servidor. Escreva com `d$addemoji (emoji).`",
            inline: true,
          },
          {
            name: "<:Sinonimos:1214053417933340692> Sinônimos:",
            value: "`d$addemoji` `d$adicionaremoji`",
            inline: true,
          },
          {
            name: "\u200b",
          ...
          },
          {
            ...
            value:
              "`d$addemoji <:ney_caze:935410173462327317>`\n`d$addemoji` <:ney_caze:935410173462327317>",
            inline: true,
          }
        );
    ...
    if (customemoji.id) {
      ...
      const degabrielofiadd = new MessageEmbed()
        .setTitle(`<a:Aeee:940101553078022185> Emoji adicionado com sucesso!`)
        .setColor(`#471515`)
